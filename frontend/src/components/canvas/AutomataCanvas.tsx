...
export const AutomataCanvas: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full bg-sky-50 dark:bg-slate-950 overflow-hidden select-none">
      ...
      >
        ...
        <Controls
          ...
          className="!m-4 !bg-sky-50 dark:!bg-slate-950 !border-sky-300 dark:!border-sky-500/30 !shadow-2xl !rounded-xl overflow-hidden"
          showInteractive={false}
        />

        <MiniMap
          position="bottom-right"
          className="!m-4 !bg-sky-50 dark:!bg-slate-950 !border-sky-300 dark:!border-sky-500/30 !rounded-2xl !shadow-2xl"
          nodeColor={(node) => {
