...
export const CanvasControls: React.FC = () => {
  ...
  return (
    <div className="flex fixed md:left-6 md:top-1/2 md:-translate-y-1/2 bottom-0 md:bottom-auto left-0 w-full md:w-auto z-50 bg-surface-container-highest/90 md:bg-surface-container-highest/90 backdrop-blur-2xl md:rounded-full rounded-t-xl rounded-b-none border-t border-x-0 border-b-0 md:border border-outline-variant/30 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] md:shadow-2xl flex-row md:flex-col items-center justify-around md:justify-center md:gap-2 md:py-6 md:px-2 px-1 pt-1.5 pb-3 overflow-x-auto md:overflow-visible hide-scrollbar">
