        ...
        >
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-2.5 py-0.5 rounded-full text-xs font-mono font-bold tracking-wider transition-all duration-200 border shadow-md cursor-pointer ${
                hasError
                  ...
                  : isActive
                  ? 'bg-cyan-500 text-white dark:text-[#1C1313] border-cyan-300 shadow-[0_0_12px_rgba(56,189,248,0.7)] scale-105'
                  : 'bg-cyan-50 dark:bg-slate-950 text-cyan-800 dark:text-cyan-200 border-cyan-500/40 hover:border-cyan-300 hover:text-slate-900 dark:hover:text-white'
              }`}
            >
              {labelText}
            </button>
            ...
            <button
              ...
              className="w-4 h-4 rounded-full bg-cyan-50 dark:bg-slate-950 border border-cyan-300 dark:border-cyan-500/30 text-slate-600 dark:text-slate-400 hover:text-rose-400 hover:border-rose-500 flex items-center justify-center text-[10px] opacity-0 group-hover:opacity-100 transition-opacity shadow-sm cursor-pointer"
            >
              ×
            </button>
          </div>
