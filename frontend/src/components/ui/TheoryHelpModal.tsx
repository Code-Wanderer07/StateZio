      ...
      <div className="bg-sky-50 dark:bg-[#1C1313] border border-sky-300 dark:border-sky-500/30 rounded-2xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] text-slate-900 dark:text-slate-100">
        ...
        <div className="p-6 space-y-6 overflow-y-auto text-xs text-slate-700 dark:text-slate-300 leading-relaxed bg-slate-50 dark:bg-[#161111]">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-[#0d1017] rounded-xl border border-sky-300 dark:border-sky-500/30 font-mono text-[11px] text-sky-800 dark:text-sky-200">
              DFA / NFA: M = (Q, Σ, δ, q₀, F)
            </div>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-[#0d1017] rounded-xl border border-sky-300 dark:border-sky-500/30 font-mono text-[11px] text-amber-700 dark:text-amber-200">
              PDA: M = (Q, Σ, Γ, δ, q₀, Z₀, F)
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-[#0d1017] rounded-xl border border-sky-300 dark:border-sky-500/30 font-mono text-[11px] text-teal-200">
