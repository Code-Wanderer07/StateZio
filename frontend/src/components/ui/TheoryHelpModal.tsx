...
export const TheoryHelpModal: React.FC<TheoryHelpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-xs p-4 animate-in fade-in duration-200 select-none">
      <div className="bg-cyan-50 dark:bg-slate-950 border border-cyan-300 dark:border-cyan-500/30 rounded-2xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] text-slate-900 dark:text-slate-100">
        {/* Header */}
        ...
        <div className="p-6 space-y-6 overflow-y-auto text-xs text-slate-700 dark:text-slate-300 leading-relaxed bg-slate-50 dark:bg-slate-900">
          ...
          <div className="p-4 rounded-xl bg-cyan-100 dark:bg-slate-900 border border-cyan-300 dark:border-cyan-500/30 space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-cyan-300 dark:border-cyan-500/30 font-mono text-[11px] text-cyan-800 dark:text-cyan-200">
              DFA / NFA: M = (Q, Σ, δ, q₀, F)
            </div>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-cyan-300 dark:border-cyan-500/30 font-mono text-[11px] text-amber-700 dark:text-amber-200">
              PDA: M = (Q, Σ, Γ, δ, q₀, Z₀, F)
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-cyan-300 dark:border-cyan-500/30 font-mono text-[11px] text-teal-200">
