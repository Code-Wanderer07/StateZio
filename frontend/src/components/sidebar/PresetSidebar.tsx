...
export const PresetSidebar: React.FC = () => {
  ...
  const getModuleBadge = (type: MachineType) => {
    if (type === 'DFA') return <span className="px-2 py-0.5 rounded-full bg-sky-500/20 text-sky-300 border border-sky-500/40 text-[10px] font-mono font-semibold">DFA</span>;
  ...
  return (
    <div className="flex flex-col h-full bg-[#161111] border-r border-sky-500/20 w-80 shadow-2xl text-slate-100 select-none">
      {/* Sidebar Header */}
      <div className="p-4 border-b border-sky-500/20 bg-[#1C1313]">
        ...
        {/* Filter Pills */}
        <div className="grid grid-cols-5 gap-1 p-1 bg-[#241919] rounded-xl border border-sky-500/30">
