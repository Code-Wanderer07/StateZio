...
export const MachineProperties: React.FC = () => {
  ...
  return (
    <div className="flex flex-col bg-cyan-50 dark:bg-slate-950 border border-cyan-300 dark:border-cyan-500/30 rounded-2xl p-4 shadow-xl space-y-3 text-slate-900 dark:text-slate-100 select-none">
      {/* Header */}
      <div className="flex items-center justify-between pb-2 border-b border-cyan-200 dark:border-cyan-500/20">
        ...
        <span className="text-[10px] font-mono px-2.5 py-0.5 rounded-full bg-cyan-500/20 text-cyan-700 dark:text-cyan-300 border border-cyan-500/40 font-bold">
      ...
      <div className="space-y-2 text-xs font-mono">
        {/* Q: States */}
        <div className="flex items-start justify-between gap-2 p-2 rounded-xl bg-cyan-200 dark:bg-slate-800 border border-cyan-200 dark:border-cyan-500/20">
          <span className="text-cyan-700 dark:text-cyan-300 font-semibold shrink-0">Q (States):</span>
        ...
        <div className="flex items-start justify-between gap-2 p-2 rounded-xl bg-cyan-200 dark:bg-slate-800 border border-cyan-200 dark:border-cyan-500/20">
          ...
          <span className="text-slate-900 dark:text-white text-right font-medium">
        ...
        {/* F: Accept States */}
        <div className="flex items-start justify-between gap-2 p-2 rounded-xl bg-cyan-200 dark:bg-slate-800 border border-cyan-200 dark:border-cyan-500/20">
          <span className="text-blue-400 font-semibold shrink-0">F (Accept):</span>
          <span className="text-slate-900 dark:text-white text-right break-words font-medium">
            {'{'}{acceptStateIds.join(', ')}{'}'}
          </span>
        </div>
        ...
        <div className="flex items-start justify-between gap-2 p-2 rounded-xl bg-cyan-200 dark:bg-slate-800 border border-cyan-200 dark:border-cyan-500/20">
          <span className="text-slate-600 dark:text-slate-400 font-semibold shrink-0">δ (Transitions):</span>
          <span className="text-slate-900 dark:text-white text-right font-medium">
