...
export const MachineProperties: React.FC = () => {
  ...
  return (
    <div className="flex flex-col bg-sky-50 dark:bg-slate-950 border border-sky-300 dark:border-sky-500/30 rounded-2xl p-4 shadow-xl space-y-3 text-slate-900 dark:text-slate-100 select-none">
      {/* Header */}
      <div className="flex items-center justify-between pb-2 border-b border-sky-200 dark:border-sky-500/20">
        ...
        <span className="text-[10px] font-mono px-2.5 py-0.5 rounded-full bg-sky-500/20 text-sky-700 dark:text-sky-300 border border-sky-500/40 font-bold">
      ...
      <div className="space-y-2 text-xs font-mono">
        {/* Q: States */}
        <div className="flex items-start justify-between gap-2 p-2 rounded-xl bg-sky-200 dark:bg-slate-800 border border-sky-200 dark:border-sky-500/20">
